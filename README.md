...
Soy **Ingeniera en Sistemas** enfocada en el desarrollo **Frontend**, con una base sólida en el mundo **Backend**. 

### Sobre mí:
* 💻 **Frontend:** Mi especialidad es **React** y **TypeScript**, creando aplicaciones modernas y escalables. 
...
![Genexus](https://img.shields.io/badge/GeneXus-FF4B12?style=for-the-badge&logo=genexus&logoColor=white)
